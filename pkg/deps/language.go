...
type Language struct {
	...
	// NewResolver creates a registry Resolver with the given HTTP cache TTL.
...
//
// The resolver is created with DefaultCacheTTL (24 hours). Use NewResolver
// directly for custom TTLs.
//
...
//
// This is a convenience wrapper around NewResolver(DefaultCacheTTL).
