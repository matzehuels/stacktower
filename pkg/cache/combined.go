...
func (c *CombinedCache) DeleteGraphEntry(ctx context.Context, key string) error {
	return c.lookup.DeleteGraphEntry(ctx, key)
}
...
func (c *CombinedCache) DeleteRenderEntry(ctx context.Context, key string) error {
	return c.lookup.DeleteRenderEntry(ctx, key)
}
...
func (c *CombinedCache) DeleteGraph(ctx context.Context, id string) error {
	return c.store.DeleteGraph(ctx, id)
}
...
func (c *CombinedCache) GetRenderByGraphAndOptions(ctx context.Context, userID, graphHash string, layoutOpts LayoutOptions) (*Render, error) {
	return c.store.GetRenderByGraphAndOptions(ctx, userID, graphHash, layoutOpts)
}
