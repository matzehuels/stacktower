...
func TestIsBrittle(t *testing.T) {
	...
	cases := []struct {
		...
		// Fallback cases: no last commit date, use maintainers/stars only
		{
			"no commit date but few maintainers",
			&dag.Node{ID: "pkg", Meta: dag.Metadata{
				"repo_stars":       5000,
				"repo_maintainers": []string{"solo-dev"},
			}},
		...
		{
			"no commit date and healthy maintainers/stars",
			&dag.Node{ID: "pkg", Meta: dag.Metadata{
				"repo_stars":       5000,
				"repo_maintainers": []string{"a", "b", "c", "d", "e"},
			}},
		...
		{
			"no commit date and no maintainers/stars info",
			&dag.Node{ID: "pkg", Meta: dag.Metadata{
