...
// =============================================================================
// Layout - Unified Visualization Output (DTO)
// =============================================================================

// Layout is the unified serialization format (DTO) for all visualizations.
//
...
//
// This is a DTO (Data Transfer Object) for serialization. For tower layouts,
// there is also an internal representation (pkg/core/render/tower/layout.Layout)
// optimized for computation. Use ToDTO()/FromDTO() to convert between them.
type Layout struct {
	// Discriminator
